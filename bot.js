// Define the bot data as an array of objects
const botData = [
    {
        "id": 101,
        "name": "wHz-93",
...
// Function to render bot data in the Tcollect div
function renderBotData() {
    const tcollectDiv = document.getElementById('Tcollect');
    botData.forEach(bot => {
        ...
        `;
        tcollectDiv.appendChild(botInfo);
    });
}

// Call the renderBotData function to display the bot data
renderBotData();
