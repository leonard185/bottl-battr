// Function to handle click event on "Enlist" button
const botData = [
    {
        "id": 101,
        "name": "wHz-93",
...
function enlistBot(botId) {
    ...
    if (bot) {
        const cont1Div = document.getElementById('Cont1');
        const botInfoDiv = document.createElement('div');
        botInfoDiv.classList.add('enlisted-bot');
        ...
        `;
        cont1Div.appendChild(botInfoDiv);
    }
}

// Modify the enlistBot function call in the renderBotCollection function
